...
const EXPRESSIVE_PALETTES = {
    orchid: { 
        light: `--md-sys-color-primary:#9333EA;--md-sys-color-on-primary:#FFFFFF;--md-sys-color-primary-container:#9333EA;--md-sys-color-on-primary-container:#FFFFFF;--md-sys-color-secondary-container:#7E22CE;--md-sys-color-on-secondary-container:#FFFFFF;--md-sys-color-tertiary-container:#A855F7;--md-sys-color-on-tertiary-container:#FFFFFF;--md-sys-color-background:#F3E8FF;--md-sys-color-on-background:#3B0764;--md-sys-color-surface:#FAF5FF;--md-sys-color-on-surface:#3B0764;--md-sys-color-surface-variant:#6B21A8;--md-sys-color-on-surface-variant:#FFFFFF;`,
    ...
    olive: { 
        light: `--md-sys-color-primary:#65A30D;--md-sys-color-on-primary:#FFFFFF;--md-sys-color-primary-container:#65A30D;--md-sys-color-on-primary-container:#FFFFFF;--md-sys-color-secondary-container:#4D7C0F;--md-sys-color-on-secondary-container:#FFFFFF;--md-sys-color-tertiary-container:#84CC16;--md-sys-color-on-tertiary-container:#FFFFFF;--md-sys-color-background:#ECFCCB;--md-sys-color-on-background:#1A2E05;--md-sys-color-surface:#F7FEE7;--md-sys-color-on-surface:#1A2E05;--md-sys-color-surface-variant:#3F6212;--md-sys-color-on-surface-variant:#FFFFFF;`, 
    ...
    coral: { 
        light: `--md-sys-color-primary:#EA580C;--md-sys-color-on-primary:#FFFFFF;--md-sys-color-primary-container:#EA580C;--md-sys-color-on-primary-container:#FFFFFF;--md-sys-color-secondary-container:#C2410C;--md-sys-color-on-secondary-container:#FFFFFF;--md-sys-color-tertiary-container:#F97316;--md-sys-color-on-tertiary-container:#FFFFFF;--md-sys-color-background:#FFEDD5;--md-sys-color-on-background:#431407;--md-sys-color-surface:#FFF7ED;--md-sys-color-on-surface:#431407;--md-sys-color-surface-variant:#9A3412;--md-sys-color-on-surface-variant:#FFFFFF;`,
    ...
    teal: { 
        light: `--md-sys-color-primary:#0D9488;--md-sys-color-on-primary:#FFFFFF;--md-sys-color-primary-container:#0D9488;--md-sys-color-on-primary-container:#FFFFFF;--md-sys-color-secondary-container:#0F766E;--md-sys-color-on-secondary-container:#FFFFFF;--md-sys-color-tertiary-container:#14B8A6;--md-sys-color-on-tertiary-container:#FFFFFF;--md-sys-color-background:#CCFBF1;--md-sys-color-on-background:#042F2E;--md-sys-color-surface:#F0FDFA;--md-sys-color-on-surface:#042F2E;--md-sys-color-surface-variant:#115E59;--md-sys-color-on-surface-variant:#FFFFFF;`,
    ...
    lavender: { 
        light: `--md-sys-color-primary:#4F46E5;--md-sys-color-on-primary:#FFFFFF;--md-sys-color-primary-container:#4F46E5;--md-sys-color-on-primary-container:#FFFFFF;--md-sys-color-secondary-container:#4338CA;--md-sys-color-on-secondary-container:#FFFFFF;--md-sys-color-tertiary-container:#6366F1;--md-sys-color-on-tertiary-container:#FFFFFF;--md-sys-color-background:#E0E7FF;--md-sys-color-on-background:#1E1B4B;--md-sys-color-surface:#EEF2FF;--md-sys-color-on-surface:#1E1B4B;--md-sys-color-surface-variant:#3730A3;--md-sys-color-on-surface-variant:#FFFFFF;`,
    ...
    rose: { 
        light: `--md-sys-color-primary:#E11D48;--md-sys-color-on-primary:#FFFFFF;--md-sys-color-primary-container:#E11D48;--md-sys-color-on-primary-container:#FFFFFF;--md-sys-color-secondary-container:#BE123C;--md-sys-color-on-secondary-container:#FFFFFF;--md-sys-color-tertiary-container:#F43F5E;--md-sys-color-on-tertiary-container:#FFFFFF;--md-sys-color-background:#FFE4E6;--md-sys-color-on-background:#4C0519;--md-sys-color-surface:#FFF1F2;--md-sys-color-on-surface:#4C0519;--md-sys-color-surface-variant:#9F1239;--md-sys-color-on-surface-variant:#FFFFFF;`, 
    ...
    lime: { 
        light: `--md-sys-color-primary:#16A34A;--md-sys-color-on-primary:#FFFFFF;--md-sys-color-primary-container:#16A34A;--md-sys-color-on-primary-container:#FFFFFF;--md-sys-color-secondary-container:#15803D;--md-sys-color-on-secondary-container:#FFFFFF;--md-sys-color-tertiary-container:#22C55E;--md-sys-color-on-tertiary-container:#FFFFFF;--md-sys-color-background:#DCFCE7;--md-sys-color-on-background:#052E16;--md-sys-color-surface:#F0FDF4;--md-sys-color-on-surface:#052E16;--md-sys-color-surface-variant:#166534;--md-sys-color-on-surface-variant:#FFFFFF;`,
    ...
    sand: { 
        light: `--md-sys-color-primary:#D97706;--md-sys-color-on-primary:#FFFFFF;--md-sys-color-primary-container:#D97706;--md-sys-color-on-primary-container:#FFFFFF;--md-sys-color-secondary-container:#B45309;--md-sys-color-on-secondary-container:#FFFFFF;--md-sys-color-tertiary-container:#F59E0B;--md-sys-color-on-tertiary-container:#FFFFFF;--md-sys-color-background:#FEF3C7;--md-sys-color-on-background:#451A03;--md-sys-color-surface:#FFFBEB;--md-sys-color-on-surface:#451A03;--md-sys-color-surface-variant:#92400E;--md-sys-color-on-surface-variant:#FFFFFF;`,
    ...
    monochrome: { 
        light: `--md-sys-color-primary:#475569;--md-sys-color-on-primary:#FFFFFF;--md-sys-color-primary-container:#475569;--md-sys-color-on-primary-container:#FFFFFF;--md-sys-color-secondary-container:#334155;--md-sys-color-on-secondary-container:#FFFFFF;--md-sys-color-tertiary-container:#64748B;--md-sys-color-on-tertiary-container:#FFFFFF;--md-sys-color-background:#E2E8F0;--md-sys-color-on-background:#0F172A;--md-sys-color-surface:#F1F5F9;--md-sys-color-on-surface:#0F172A;--md-sys-color-surface-variant:#1E293B;--md-sys-color-on-surface-variant:#FFFFFF;`, 
    ...
    blueberry: { 
        light: `--md-sys-color-primary:#2563EB;--md-sys-color-on-primary:#FFFFFF;--md-sys-color-primary-container:#2563EB;--md-sys-color-on-primary-container:#FFFFFF;--md-sys-color-secondary-container:#1D4ED8;--md-sys-color-on-secondary-container:#FFFFFF;--md-sys-color-tertiary-container:#3B82F6;--md-sys-color-on-tertiary-container:#FFFFFF;--md-sys-color-background:#DBEAFE;--md-sys-color-on-background:#1E3A8A;--md-sys-color-surface:#EFF6FF;--md-sys-color-on-surface:#1E3A8A;--md-sys-color-surface-variant:#1E40AF;--md-sys-color-on-surface-variant:#FFFFFF;`, 
...
const STANDARD_PALETTES = EXPRESSIVE_PALETTES;

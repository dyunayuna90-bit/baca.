...
const STANDARD_PALETTES = {
    orchid: { // Standard Material You — Orchid/Purple
        light: `--md-sys-color-primary:#7C3AED;--md-sys-color-on-primary:#FFFFFF;--md-sys-color-primary-container:#EDE9FE;--md-sys-color-on-primary-container:#4C1D95;--md-sys-color-secondary-container:#DDD6FE;--md-sys-color-on-secondary-container:#5B21B6;--md-sys-color-tertiary-container:#F5F3FF;--md-sys-color-on-tertiary-container:#6D28D9;--md-sys-color-background:#7C3AED;--md-sys-color-on-background:#FFFFFF;--md-sys-color-surface:#8B5CF6;--md-sys-color-on-surface:#FFFFFF;--md-sys-color-surface-variant:#A78BFA;--md-sys-color-on-surface-variant:#EDE9FE;`,
    ...
    olive: { // Standard Material You — Olive Green
        light: `--md-sys-color-primary:#3F6212;--md-sys-color-on-primary:#FFFFFF;--md-sys-color-primary-container:#D9F99D;--md-sys-color-on-primary-container:#1A2E05;--md-sys-color-secondary-container:#BEF264;--md-sys-color-on-secondary-container:#1E3A00;--md-sys-color-tertiary-container:#ECFCCB;--md-sys-color-on-tertiary-container:#1A2E05;--md-sys-color-background:#4D7C0F;--md-sys-color-on-background:#FFFFFF;--md-sys-color-surface:#65A30D;--md-sys-color-on-surface:#FFFFFF;--md-sys-color-surface-variant:#A3E635;--md-sys-color-on-surface-variant:#1A2E05;`,
    ...
    coral: { // Standard Material You — Coral/Red
        light: `--md-sys-color-primary:#DC2626;--md-sys-color-on-primary:#FFFFFF;--md-sys-color-primary-container:#FEE2E2;--md-sys-color-on-primary-container:#7F1D1D;--md-sys-color-secondary-container:#FECACA;--md-sys-color-on-secondary-container:#991B1B;--md-sys-color-tertiary-container:#FEF2F2;--md-sys-color-on-tertiary-container:#7F1D1D;--md-sys-color-background:#DC2626;--md-sys-color-on-background:#FFFFFF;--md-sys-color-surface:#EF4444;--md-sys-color-on-surface:#FFFFFF;--md-sys-color-surface-variant:#F87171;--md-sys-color-on-surface-variant:#FEF2F2;`,
    ...
    teal: { // Standard Material You — Teal
        light: `--md-sys-color-primary:#0F766E;--md-sys-color-on-primary:#FFFFFF;--md-sys-color-primary-container:#CCFBF1;--md-sys-color-on-primary-container:#003D37;--md-sys-color-secondary-container:#99F6E4;--md-sys-color-on-secondary-container:#003D37;--md-sys-color-tertiary-container:#F0FDFA;--md-sys-color-on-tertiary-container:#0D4B46;--md-sys-color-background:#0F766E;--md-sys-color-on-background:#FFFFFF;--md-sys-color-surface:#0D9488;--md-sys-color-on-surface:#FFFFFF;--md-sys-color-surface-variant:#2DD4BF;--md-sys-color-on-surface-variant:#F0FDFA;`,
    ...
    lavender: { // Standard Material You — Lavender/Indigo
        light: `--md-sys-color-primary:#4338CA;--md-sys-color-on-primary:#FFFFFF;--md-sys-color-primary-container:#E0E7FF;--md-sys-color-on-primary-container:#1E1B4B;--md-sys-color-secondary-container:#C7D2FE;--md-sys-color-on-secondary-container:#1E1B4B;--md-sys-color-tertiary-container:#EEF2FF;--md-sys-color-on-tertiary-container:#312E81;--md-sys-color-background:#4338CA;--md-sys-color-on-background:#FFFFFF;--md-sys-color-surface:#4F46E5;--md-sys-color-on-surface:#FFFFFF;--md-sys-color-surface-variant:#818CF8;--md-sys-color-on-surface-variant:#EEF2FF;`,
    ...
    rose: { // Standard Material You — Rose/Pink
        light: `--md-sys-color-primary:#BE123C;--md-sys-color-on-primary:#FFFFFF;--md-sys-color-primary-container:#FFE4E6;--md-sys-color-on-primary-container:#881337;--md-sys-color-secondary-container:#FECDD3;--md-sys-color-on-secondary-container:#9F1239;--md-sys-color-tertiary-container:#FFF1F2;--md-sys-color-on-tertiary-container:#881337;--md-sys-color-background:#BE123C;--md-sys-color-on-background:#FFFFFF;--md-sys-color-surface:#E11D48;--md-sys-color-on-surface:#FFFFFF;--md-sys-color-surface-variant:#FB7185;--md-sys-color-on-surface-variant:#FFF1F2;`,
    ...
    lime: { // Standard Material You — Lime/Green
        light: `--md-sys-color-primary:#4D7C0F;--md-sys-color-on-primary:#FFFFFF;--md-sys-color-primary-container:#ECFCCB;--md-sys-color-on-primary-container:#1A2E05;--md-sys-color-secondary-container:#D9F99D;--md-sys-color-on-secondary-container:#1E3A00;--md-sys-color-tertiary-container:#F7FEE7;--md-sys-color-on-tertiary-container:#132000;--md-sys-color-background:#4D7C0F;--md-sys-color-on-background:#FFFFFF;--md-sys-color-surface:#65A30D;--md-sys-color-on-surface:#FFFFFF;--md-sys-color-surface-variant:#84CC16;--md-sys-color-on-surface-variant:#ECFCCB;`,
    ...
    sand: { // Standard Material You — Sand/Amber
        light: `--md-sys-color-primary:#92400E;--md-sys-color-on-primary:#FFFFFF;--md-sys-color-primary-container:#FEF3C7;--md-sys-color-on-primary-container:#451A03;--md-sys-color-secondary-container:#FDE68A;--md-sys-color-on-secondary-container:#713F12;--md-sys-color-tertiary-container:#FFFBEB;--md-sys-color-on-tertiary-container:#451A03;--md-sys-color-background:#B45309;--md-sys-color-on-background:#FFFFFF;--md-sys-color-surface:#D97706;--md-sys-color-on-surface:#FFFFFF;--md-sys-color-surface-variant:#F59E0B;--md-sys-color-on-surface-variant:#FFFBEB;`,
    ...
    monochrome: { // Standard Material You — Slate/Mono
        light: `--md-sys-color-primary:#334155;--md-sys-color-on-primary:#FFFFFF;--md-sys-color-primary-container:#E2E8F0;--md-sys-color-on-primary-container:#0F172A;--md-sys-color-secondary-container:#CBD5E1;--md-sys-color-on-secondary-container:#1E293B;--md-sys-color-tertiary-container:#F1F5F9;--md-sys-color-on-tertiary-container:#0F172A;--md-sys-color-background:#334155;--md-sys-color-on-background:#FFFFFF;--md-sys-color-surface:#475569;--md-sys-color-on-surface:#FFFFFF;--md-sys-color-surface-variant:#64748B;--md-sys-color-on-surface-variant:#F1F5F9;`,
    ...
    blueberry: { // Standard Material You — Blue/Cobalt
        light: `--md-sys-color-primary:#1D4ED8;--md-sys-color-on-primary:#FFFFFF;--md-sys-color-primary-container:#DBEAFE;--md-sys-color-on-primary-container:#1E3A8A;--md-sys-color-secondary-container:#BFDBFE;--md-sys-color-on-secondary-container:#1E40AF;--md-sys-color-tertiary-container:#EFF6FF;--md-sys-color-on-tertiary-container:#1E3A8A;--md-sys-color-background:#2563EB;--md-sys-color-on-background:#FFFFFF;--md-sys-color-surface:#3B82F6;--md-sys-color-on-surface:#FFFFFF;--md-sys-color-surface-variant:#60A5FA;--md-sys-color-on-surface-variant:#EFF6FF;`,

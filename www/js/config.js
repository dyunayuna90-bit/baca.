...
// Data Palet Warna Material 3 - Mode Ekspresif
const EXPRESSIVE_PALETTES = {
    orchid: { 
        light: `--md-sys-color-primary:#9333EA;--md-sys-color-on-primary:#FFFFFF;--md-sys-color-primary-container:#A855F7;--md-sys-color-on-primary-container:#FFFFFF;--md-sys-color-secondary-container:#7E22CE;--md-sys-color-on-secondary-container:#FFFFFF;--md-sys-color-tertiary-container:#F472B6;--md-sys-color-on-tertiary-container:#FFFFFF;--md-sys-color-background:#FDF4FF;--md-sys-color-on-background:#3B0764;--md-sys-color-surface:#FAF5FF;--md-sys-color-on-surface:#3B0764;--md-sys-color-surface-variant:#6B21A8;--md-sys-color-on-surface-variant:#FFFFFF;`,
    ...
    olive: { 
        light: `--md-sys-color-primary:#65A30D;--md-sys-color-on-primary:#FFFFFF;--md-sys-color-primary-container:#4D7C0F;--md-sys-color-on-primary-container:#FFFFFF;--md-sys-color-secondary-container:#3F6212;--md-sys-color-on-secondary-container:#FFFFFF;--md-sys-color-tertiary-container:#F59E0B;--md-sys-color-on-tertiary-container:#FFFFFF;--md-sys-color-background:#F7FEE7;--md-sys-color-on-background:#1A2E05;--md-sys-color-surface:#F3F4ED;--md-sys-color-on-surface:#1A2E05;--md-sys-color-surface-variant:#3F6212;--md-sys-color-on-surface-variant:#FFFFFF;`, 
    ...
    coral: { 
        light: `--md-sys-color-primary:#EA580C;--md-sys-color-on-primary:#FFFFFF;--md-sys-color-primary-container:#C2410C;--md-sys-color-on-primary-container:#FFFFFF;--md-sys-color-secondary-container:#9A3412;--md-sys-color-on-secondary-container:#FFFFFF;--md-sys-color-tertiary-container:#0D9488;--md-sys-color-on-tertiary-container:#FFFFFF;--md-sys-color-background:#FFF7ED;--md-sys-color-on-background:#431407;--md-sys-color-surface:#FFFBFA;--md-sys-color-on-surface:#431407;--md-sys-color-surface-variant:#9A3412;--md-sys-color-on-surface-variant:#FFFFFF;`,
    ...
    teal: { 
        light: `--md-sys-color-primary:#0D9488;--md-sys-color-on-primary:#FFFFFF;--md-sys-color-primary-container:#0F766E;--md-sys-color-on-primary-container:#FFFFFF;--md-sys-color-secondary-container:#115E59;--md-sys-color-on-secondary-container:#FFFFFF;--md-sys-color-tertiary-container:#EC4899;--md-sys-color-on-tertiary-container:#FFFFFF;--md-sys-color-background:#F0FDFA;--md-sys-color-on-background:#042F2E;--md-sys-color-surface:#FFFFFF;--md-sys-color-on-surface:#042F2E;--md-sys-color-surface-variant:#115E59;--md-sys-color-on-surface-variant:#FFFFFF;`,
    ...
    lavender: { 
        light: `--md-sys-color-primary:#4F46E5;--md-sys-color-on-primary:#FFFFFF;--md-sys-color-primary-container:#4338CA;--md-sys-color-on-primary-container:#FFFFFF;--md-sys-color-secondary-container:#3730A3;--md-sys-color-on-secondary-container:#FFFFFF;--md-sys-color-tertiary-container:#10B981;--md-sys-color-on-tertiary-container:#FFFFFF;--md-sys-color-background:#EEF2FF;--md-sys-color-on-background:#1E1B4B;--md-sys-color-surface:#FCFAFF;--md-sys-color-on-surface:#1E1B4B;--md-sys-color-surface-variant:#3730A3;--md-sys-color-on-surface-variant:#FFFFFF;`,
    ...
    rose: { 
        light: `--md-sys-color-primary:#E11D48;--md-sys-color-on-primary:#FFFFFF;--md-sys-color-primary-container:#BE123C;--md-sys-color-on-primary-container:#FFFFFF;--md-sys-color-secondary-container:#9F1239;--md-sys-color-on-secondary-container:#FFFFFF;--md-sys-color-tertiary-container:#EAB308;--md-sys-color-on-tertiary-container:#000000;--md-sys-color-background:#FFF1F2;--md-sys-color-on-background:#4C0519;--md-sys-color-surface:#FFFBFB;--md-sys-color-on-surface:#4C0519;--md-sys-color-surface-variant:#9F1239;--md-sys-color-on-surface-variant:#FFFFFF;`, 
    ...
    lime: { 
        light: `--md-sys-color-primary:#16A34A;--md-sys-color-on-primary:#FFFFFF;--md-sys-color-primary-container:#15803D;--md-sys-color-on-primary-container:#FFFFFF;--md-sys-color-secondary-container:#166534;--md-sys-color-on-secondary-container:#FFFFFF;--md-sys-color-tertiary-container:#A855F7;--md-sys-color-on-tertiary-container:#FFFFFF;--md-sys-color-background:#F0FDF4;--md-sys-color-on-background:#052E16;--md-sys-color-surface:#FCFDF7;--md-sys-color-on-surface:#052E16;--md-sys-color-surface-variant:#166534;--md-sys-color-on-surface-variant:#FFFFFF;`,
    ...
    sand: { 
        light: `--md-sys-color-primary:#D97706;--md-sys-color-on-primary:#FFFFFF;--md-sys-color-primary-container:#B45309;--md-sys-color-on-primary-container:#FFFFFF;--md-sys-color-secondary-container:#92400E;--md-sys-color-on-secondary-container:#FFFFFF;--md-sys-color-tertiary-container:#3B82F6;--md-sys-color-on-tertiary-container:#FFFFFF;--md-sys-color-background:#FFFBEB;--md-sys-color-on-background:#451A03;--md-sys-color-surface:#FFFDF9;--md-sys-color-on-surface:#451A03;--md-sys-color-surface-variant:#92400E;--md-sys-color-on-surface-variant:#FFFFFF;`,
    ...
    monochrome: { 
        light: `--md-sys-color-primary:#475569;--md-sys-color-on-primary:#FFFFFF;--md-sys-color-primary-container:#334155;--md-sys-color-on-primary-container:#FFFFFF;--md-sys-color-secondary-container:#1E293B;--md-sys-color-on-secondary-container:#FFFFFF;--md-sys-color-tertiary-container:#0F172A;--md-sys-color-on-tertiary-container:#FFFFFF;--md-sys-color-background:#F8FAFC;--md-sys-color-on-background:#0F172A;--md-sys-color-surface:#FAFAFA;--md-sys-color-on-surface:#0F172A;--md-sys-color-surface-variant:#1E293B;--md-sys-color-on-surface-variant:#FFFFFF;`, 
    ...
    blueberry: { 
        light: `--md-sys-color-primary:#2563EB;--md-sys-color-on-primary:#FFFFFF;--md-sys-color-primary-container:#1D4ED8;--md-sys-color-on-primary-container:#FFFFFF;--md-sys-color-secondary-container:#1E40AF;--md-sys-color-on-secondary-container:#FFFFFF;--md-sys-color-tertiary-container:#F43F5E;--md-sys-color-on-tertiary-container:#FFFFFF;--md-sys-color-background:#EFF6FF;--md-sys-color-on-background:#00153B;--md-sys-color-surface:#F4F9FF;--md-sys-color-on-surface:#00153B;--md-sys-color-surface-variant:#1E40AF;--md-sys-color-on-surface-variant:#FFFFFF;`, 
...
// Data Palet Warna Material 3 - Mode Standar (Material You Asli)
const STANDARD_PALETTES = {
    orchid: {
        light: `--md-sys-color-primary:#7C3AED;--md-sys-color-on-primary:#FFFFFF;--md-sys-color-primary-container:#EDE9FE;--md-sys-color-on-primary-container:#4C1D95;--md-sys-color-secondary-container:#DDD6FE;--md-sys-color-on-secondary-container:#5B21B6;--md-sys-color-tertiary-container:#F5F3FF;--md-sys-color-on-tertiary-container:#6D28D9;--md-sys-color-background:#FAF5FF;--md-sys-color-on-background:#4C1D95;--md-sys-color-surface:#FFFFFF;--md-sys-color-on-surface:#1C1B1E;--md-sys-color-surface-variant:#7C3AED;--md-sys-color-on-surface-variant:#FFFFFF;`,
    ...
    olive: {
        light: `--md-sys-color-primary:#3F6212;--md-sys-color-on-primary:#FFFFFF;--md-sys-color-primary-container:#D9F99D;--md-sys-color-on-primary-container:#1A2E05;--md-sys-color-secondary-container:#BEF264;--md-sys-color-on-secondary-container:#1E3A00;--md-sys-color-tertiary-container:#ECFCCB;--md-sys-color-on-tertiary-container:#1A2E05;--md-sys-color-background:#F7FEE7;--md-sys-color-on-background:#1A2E05;--md-sys-color-surface:#FFFFFF;--md-sys-color-on-surface:#1A2E05;--md-sys-color-surface-variant:#3F6212;--md-sys-color-on-surface-variant:#FFFFFF;`,
    ...
    coral: {
        light: `--md-sys-color-primary:#DC2626;--md-sys-color-on-primary:#FFFFFF;--md-sys-color-primary-container:#FEE2E2;--md-sys-color-on-primary-container:#7F1D1D;--md-sys-color-secondary-container:#FECACA;--md-sys-color-on-secondary-container:#991B1B;--md-sys-color-tertiary-container:#FEF2F2;--md-sys-color-on-tertiary-container:#7F1D1D;--md-sys-color-background:#FFF7F5;--md-sys-color-on-background:#7F1D1D;--md-sys-color-surface:#FFFFFF;--md-sys-color-on-surface:#3E0E00;--md-sys-color-surface-variant:#DC2626;--md-sys-color-on-surface-variant:#FFFFFF;`,
    ...
    teal: {
        light: `--md-sys-color-primary:#0F766E;--md-sys-color-on-primary:#FFFFFF;--md-sys-color-primary-container:#CCFBF1;--md-sys-color-on-primary-container:#003D37;--md-sys-color-secondary-container:#99F6E4;--md-sys-color-on-secondary-container:#003D37;--md-sys-color-tertiary-container:#F0FDFA;--md-sys-color-on-tertiary-container:#0D4B46;--md-sys-color-background:#F0FDFA;--md-sys-color-on-background:#003D37;--md-sys-color-surface:#FFFFFF;--md-sys-color-on-surface:#002026;--md-sys-color-surface-variant:#0F766E;--md-sys-color-on-surface-variant:#FFFFFF;`,
    ...
    lavender: {
        light: `--md-sys-color-primary:#4338CA;--md-sys-color-on-primary:#FFFFFF;--md-sys-color-primary-container:#E0E7FF;--md-sys-color-on-primary-container:#1E1B4B;--md-sys-color-secondary-container:#C7D2FE;--md-sys-color-on-secondary-container:#1E1B4B;--md-sys-color-tertiary-container:#EEF2FF;--md-sys-color-on-tertiary-container:#312E81;--md-sys-color-background:#FAF5FF;--md-sys-color-on-background:#1E1B4B;--md-sys-color-surface:#FFFFFF;--md-sys-color-on-surface:#1D0061;--md-sys-color-surface-variant:#4338CA;--md-sys-color-on-surface-variant:#FFFFFF;`,
    ...
    rose: {
        light: `--md-sys-color-primary:#BE123C;--md-sys-color-on-primary:#FFFFFF;--md-sys-color-primary-container:#FFE4E6;--md-sys-color-on-primary-container:#881337;--md-sys-color-secondary-container:#FECDD3;--md-sys-color-on-secondary-container:#9F1239;--md-sys-color-tertiary-container:#FFF1F2;--md-sys-color-on-tertiary-container:#881337;--md-sys-color-background:#FFF5F5;--md-sys-color-on-background:#881337;--md-sys-color-surface:#FFFFFF;--md-sys-color-on-surface:#450A0A;--md-sys-color-surface-variant:#BE123C;--md-sys-color-on-surface-variant:#FFFFFF;`,
    ...
    lime: {
        light: `--md-sys-color-primary:#4D7C0F;--md-sys-color-on-primary:#FFFFFF;--md-sys-color-primary-container:#ECFCCB;--md-sys-color-on-primary-container:#1A2E05;--md-sys-color-secondary-container:#D9F99D;--md-sys-color-on-secondary-container:#1E3A00;--md-sys-color-tertiary-container:#F7FEE7;--md-sys-color-on-tertiary-container:#132000;--md-sys-color-background:#F7FEE7;--md-sys-color-on-background:#1A2E05;--md-sys-color-surface:#FFFFFF;--md-sys-color-on-surface:#132000;--md-sys-color-surface-variant:#4D7C0F;--md-sys-color-on-surface-variant:#FFFFFF;`,
    ...
    sand: {
        light: `--md-sys-color-primary:#92400E;--md-sys-color-on-primary:#FFFFFF;--md-sys-color-primary-container:#FEF3C7;--md-sys-color-on-primary-container:#451A03;--md-sys-color-secondary-container:#FDE68A;--md-sys-color-on-secondary-container:#713F12;--md-sys-color-tertiary-container:#FFFBEB;--md-sys-color-on-tertiary-container:#451A03;--md-sys-color-background:#FDFBF7;--md-sys-color-on-background:#451A03;--md-sys-color-surface:#FFFFFF;--md-sys-color-on-surface:#3E2723;--md-sys-color-surface-variant:#92400E;--md-sys-color-on-surface-variant:#FFFFFF;`,
    ...
    monochrome: {
        light: `--md-sys-color-primary:#334155;--md-sys-color-on-primary:#FFFFFF;--md-sys-color-primary-container:#E2E8F0;--md-sys-color-on-primary-container:#0F172A;--md-sys-color-secondary-container:#CBD5E1;--md-sys-color-on-secondary-container:#1E293B;--md-sys-color-tertiary-container:#F1F5F9;--md-sys-color-on-tertiary-container:#0F172A;--md-sys-color-background:#F1F5F9;--md-sys-color-on-background:#0F172A;--md-sys-color-surface:#FFFFFF;--md-sys-color-on-surface:#212121;--md-sys-color-surface-variant:#334155;--md-sys-color-on-surface-variant:#FFFFFF;`,
    ...
    blueberry: {
        light: `--md-sys-color-primary:#1D4ED8;--md-sys-color-on-primary:#FFFFFF;--md-sys-color-primary-container:#DBEAFE;--md-sys-color-on-primary-container:#1E3A8A;--md-sys-color-secondary-container:#BFDBFE;--md-sys-color-on-secondary-container:#1E40AF;--md-sys-color-tertiary-container:#EFF6FF;--md-sys-color-on-tertiary-container:#1E3A8A;--md-sys-color-background:#EFF6FF;--md-sys-color-on-background:#1E3A8A;--md-sys-color-surface:#FFFFFF;--md-sys-color-on-surface:#00153B;--md-sys-color-surface-variant:#1D4ED8;--md-sys-color-on-surface-variant:#FFFFFF;`,
